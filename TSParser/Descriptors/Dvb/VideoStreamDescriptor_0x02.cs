...
namespace TSParser.Descriptors.Dvb
{
    public record VideoStreamDescriptor_0x02 : Descriptor
    {
        ...
        public override string Print(int prefixLen)
        {
            ...
            return $"{header}Descriptor tag: 0x{DescriptorTag:X2}, {DescriptorName}, Mpeg1 Only Flag: {Mpeg1OnlyFlag}, Frame Rate Code: {FrameRateCode}, Profile And Level Indication: {ProfileAndLevelIndication}\n";
        }
    }
}
