...
{
    public record ExtendedDescriptor : Descriptor
    {
        ...
        public ExtendedDescriptor(ReadOnlySpan<byte> bytes) : base(bytes)
        {
            var pointer = 2;
        ...
        public override string Print(int prefixLen)
        {
            ...
            return $"{header}Descriptor tag: 0x{DescriptorTag:X2}, {DescriptorName}, Extension tag: {DescriptorTagExtension}, {ExtensionDescriptorName}\n";
        }
    }
}
