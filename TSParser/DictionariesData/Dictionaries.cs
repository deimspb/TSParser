...
namespace TSParser.DictionariesData
{
    internal class Dictionaries
    {
        ...
        internal static readonly Dictionary<byte, string> DescriptorNames = new Dictionary<byte, string>()
        {
            ...
            //{0x89,"Settings descriptor v1 -=Custom=-"},
            {0x89,"EwsReady Region descriptor -=Custom=-" },
            ...
            {0x8E,"ATSC"},
            {0x8F,"ATSC"},
            //{0x90,"Settings descriptor v2 -=Custom=-"},
            {0x90,"EWS Zone descriptor -=Custom=-" },
            {0x91,"ATSC"},
            {0x92,"ATSC"},
            {0x93,"ATSC"},
            {0x94,"ATSC"},
            ...
            {0xAE,"ATSC"},
            {0xAF,"ATSC"},
            {0xB0,"Settings descriptor v3 -=Custom=-"},
            {0xB1,"Settings descriptor v4 -=Custom=-"},
